#!/bin/bash
# Submit CellFlux training job to Sherlock (H100 preferred — 56M param UNet)
# Usage: bash scripts/submit_cellflux.sh [config_name]
#   e.g. bash scripts/submit_cellflux.sh cellflux-bbbc021-lb
